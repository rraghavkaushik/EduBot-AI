...
class TestEndToEndWorkflow:
    ...
    def test_complete_user_workflow(self, client):
        ...
        # Step 1: Register
        response = client.post('/api/auth/register',
                              json={'email': 'workflow@example.com', 'password': 'pass123'})
        assert response.status_code == 201
        ...
        # Step 4: Upload file
        files = {'file': ('workflow.txt', 'Sample text for workflow test', 'text/plain')}
...
class TestDatabaseIntegration:
    ...
    def test_user_document_relationship(self, client, auth_headers):
        ...
        # Upload a file
        files = {'file': ('reltest.txt', 'Relationship test', 'text/plain')}
